import 'package:cookpad_application/firebase_options.dart';
import 'package:cookpad_application/provider/recipe_provider.dart';
import 'package:cookpad_application/screens/auth_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'cookpad_application',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
          colorSchemeSeed: Colors.white,
          brightness: Brightness.light,
          // scaffoldBackgroundColor: const Color(Colors.white),
          useMaterial3: true,
